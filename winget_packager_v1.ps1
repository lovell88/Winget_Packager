...
# ask if it is in the system or user context context
...
if ($sysConType -eq "system") {
    ...
    if ($wingetCheck -match "Microsoft.DesktopAppInstaller") {
        ...
        winget install --exact --id $ProgramName --silent --accept-package-agreements --accept-source-agreements --scope=machine       
    }
...
elseif ($sysConType -eq "user") {
    ...
    if ($wingetCheck -match "Microsoft.DesktopAppInstaller") {
        ...
        winget install --exact --id $ProgramName --silent --accept-package-agreements --accept-source-agreements --scope=user       
    }
